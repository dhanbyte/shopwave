...
export default function Checkout(){
  ...
  // Calculate final total with referral discount
      ...
      if (result.isValid) {
        ...
        setReferralValidation({
          ...
          message: result.discountAmount > 0 
            ? `Referral code applied! You saved ₹${result.discountAmount} on Tech products`
            : 'Referral code valid but no Tech products in cart'
        })
      } else {
        setReferralDiscount(0)
        setReferralValidation({
    ...
    <>
      ...
      <div className="grid gap-6 md:grid-cols-[1fr_360px] md:items-start">
        ...
        <div className="card sticky top-24 p-4">
          ...
          >
              {isProcessing ? 'Processing...' : `Pay ₹${finalTotal.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
          </Button>
